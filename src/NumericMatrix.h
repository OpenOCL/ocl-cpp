...
typedef EigenMatrixX NumericMatrix;
...
static EigenMatrixX pow(const EigenMatrix& m, const Scalar exponent) {
  return m.array().pow(exponent);
}

// reduction
static EigenMatrixX norm(const EigenMatrix& m) { return fromScalar(m.norm()); }
static EigenMatrixX sum(const EigenMatrix& m) { return fromScalar(m.sum()); }
static EigenMatrixX min(const EigenMatrix& m) { return fromScalar(m.minCoeff()); }
static EigenMatrixX max(const EigenMatrix& m) { return fromScalar(m.maxCoeff()); }
static EigenMatrixX mean(const EigenMatrix& m) { return fromScalar(m.mean()); }
static EigenMatrixX trace(const EigenMatrix& m) { return fromScalar(m.trace()); }
static EigenMatrixX prod(const EigenMatrix& m) { return fromScalar(m.prod()); }

// geometrical
static EigenMatrixX reshape(const EigenMatrixX& m, Integer rows, Integer cols) {
...
static EigenMatrixX transpose(const EigenMatrixX& m) { return m.transpose(); }
// get block slice of cols (i:j) and rows (k:l)
static EigenMatrixX block(const EigenMatrixX& m, Integer i, Integer j, Integer k, Integer l) { return m.block(i,k,j-i+1,l-k+1); }
// get element at (i,k)
static EigenMatrixX slice(const EigenMatrixX& m, Integer i, Integer k) { return m.block(i,k,1,1); }

// binary coefficient wise
static EigenMatrixX ctimes(const EigenMatrixX& m1, const EigenMatrixX& m2) { return m1.array() * m2.array(); }
static EigenMatrixX cplus(const EigenMatrixX& m1, const EigenMatrixX& m2) { return m1.array() + m2.array(); }
static EigenMatrixX cdiv(const EigenMatrixX& m1, const EigenMatrixX& m2) { return m1.array() / m2.array(); }
static EigenMatrixX cminus(const EigenMatrixX& m1, const EigenMatrixX& m2) { return m1.array() - m2.array(); }

// binary operations
static EigenMatrixX times(const EigenMatrixX& m1, const EigenMatrixX& m2) { return m1 * m2; }

static EigenMatrixX cross(const EigenMatrixX& m1, const EigenMatrixX& m2) {
...
static EigenMatrixX dot(const EigenMatrixX& m1, const EigenMatrixX& m2) {
